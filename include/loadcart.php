...
// вывод мини информации возле значка карт на главной странице - в строку указываем сколько товаров в корзине их общая стоимость.
...
$int = $int + ($row["price"] * $row["cart_count"]); 
 ...
 // проверка на колличество товаров и подставляем нужное окончание
