...
<head>
 ...
 $(document).ready(function(){
    $('#form_reg').validate(
    {
        ...
        // выводимые сообщения при нарушении соотвецтвующих правил
        messages:{
            "reg_login":{
            ...
            "reg_surname":{
             ...
             "reg_email":{
               ...
               "reg_phone":{
                ...
                remote:"Не верный код с картинки!"
            }
            
        },
        //то что будет происходить по нажатию на кнопку регистрация - обращение к обработчику и т д
